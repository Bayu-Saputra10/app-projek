...
<div class="col-lg-10 mx-auto">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
          ...
          <form action="{{url('bulan')}}" method="get" class="d-flex justify-content-center align-items-center mb-3">
            @csrf
            <div class="row g-2">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover example" id="example">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Nama</th>
